...
public class MeetupAuthActivity extends Activity {
    ...
    public static final String REDIRECT_URI_HOST = "com.example.hotspot";
    public static final String REDIRECT_URI_HOST_APP = "hotspot";
    public static final String REDIRECT_URI = REDIRECT_URI_SCHEME + "://" + REDIRECT_URI_HOST + "/";
    public static final String CONSUMER_KEY = "bve6a5sg6tllb8itckm88j8vpd";
    public static final String CONSUMER_SECRET = "q1avr72ua38lvo8gtmvenolnib";
